...
const API = {
  ...
  favorites: () => API.req('/favorites'),
  toggleFavorite: (pid) => API.req('/favorites', { method: 'POST', body: JSON.stringify({ project_id: pid }) }),
  ...
  aiTest: (d) => API.req('/ai/test', { method: 'POST', body: JSON.stringify(d) }),
