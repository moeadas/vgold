...
-- ----------------------------------------
-- 1. Extend activity_log.entity_type enum
--    Adds 'Campaign' if not already present
-- ----------------------------------------
ALTER TABLE `activity_log`
  MODIFY COLUMN `entity_type` enum('Lead','User','Document','Interaction','System','Campaign') NOT NULL;

-- ----------------------------------------
-- 2. Create email_templates
-- ----------------------------------------
CREATE TABLE IF NOT EXISTS `email_templates` (
  `template_id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(200) NOT NULL,
  `subject` varchar(255) DEFAULT NULL,
  `content_json` longtext COMMENT 'JSON block structure for builder',
  `content_html` longtext COMMENT 'Rendered HTML output',
...
-- ----------------------------------------
-- 7. Default SMTP / Email Marketing settings
--    INSERT IGNORE = skip if key already exists
-- ----------------------------------------
...
-- ============================================
-- Migration complete!
-- New tables: email_templates, email_lists,
--   email_list_members, email_campaigns,
--   email_campaign_log
-- Updated: activity_log.entity_type + 'Campaign'
-- Added: 11 default SMTP settings rows
-- ============================================
