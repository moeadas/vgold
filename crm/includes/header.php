...
<head>
    ...
    :root{
        --color-accent:#7e6549; --color-accent-hover:#5C4A38; --color-accent-bg:#F0E8DC;
        --color-bg:#F6F1E7; --color-surface:#FFFFFF; --color-bg-hover:#FBFAF7;
        --color-text:#3D2E22; --color-text-primary:#3D2E22; --color-text-secondary:#6B5A4A;
        --color-text-tertiary:#9A8A78; --color-text-muted:#9A8A78;
        --color-border:rgba(61,46,34,.08); --color-border-light:rgba(61,46,34,.16);
        --color-success:#5B8C5A; --color-danger:#C54B3C; --color-warning:#C99520; --color-info:#4A7C9B;
    }
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="nav-menu">
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/dashboard.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : ''; ?>">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                    <span>Dashboard</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/leads.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'leads.php' ? 'active' : ''; ?>">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    <span>Leads</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/interactions.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'interactions.php' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/proposals.php" class="nav-link <?php echo in_array(basename($_SERVER['PHP_SELF']), ['proposals.php','proposal-form.php']) ? 'active' : ''; ?>">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                    <span>Proposals</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/reports.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'reports.php' ? 'active' : ''; ?>">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
                    <span>Reports</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/export.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'export.php' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/email-campaigns.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'email-campaigns.php' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/email-templates.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'email-templates.php' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/email-lists.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'email-lists.php' ? 'active' : ''; ?>">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
            ...
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/voip-dashboard.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'voip-dashboard.php' ? 'active' : ''; ?>">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                    <span>VoIP Calls</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/whatsapp-dashboard.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'whatsapp-dashboard.php' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/automation.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'automation.php' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/quick-guides.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'quick-guides.php' ? 'active' : ''; ?>">
            ...
            <?php if (hasRole('Admin')): ?>
                <li><hr class="nav-divider"></li>
                <li class="nav-item">
                    <a href="<?php echo CRM_BASE; ?>/pages/users.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'users.php' ? 'active' : ''; ?>">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                        <span>Users</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo CRM_BASE; ?>/pages/settings.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'settings.php' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/pages/profile.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'profile.php' ? 'active' : ''; ?>">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    <span>Profile</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo CRM_BASE; ?>/logout.php" class="nav-link" style="color:var(--color-danger);">
